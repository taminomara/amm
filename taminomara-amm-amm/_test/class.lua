...
suite:case("Base", function ()
    ...
    test.assertEq(class.Base.__module, "amm.util.class")
    test.assertEq(class.Base:New().__module, "amm.util.class")
    test.assertEq(class.Base.__fullname, "amm.util.class.Base")
    test.assertEq(class.Base:New().__fullname, "amm.util.class.Base")
...
suite:case("create", function()
    ...
    test.assertEq(C.__module, "amm.test.class.<locals>")
    test.assertEq(C:New().__module, "amm.test.class.<locals>")
    test.assertEq(C.__fullname, "amm.test.class.<locals>.C")
    test.assertEq(C:New().__fullname, "amm.test.class.<locals>.C")
end)
