...
suite:case("Base", function ()
    ...
    test.assertEq(class.Base:New().__module, "ammcore.class")
    test.assertEq(class.Base.__fullname, "ammcore.class.Base")
    test.assertEq(class.Base:New().__fullname, "ammcore.class.Base")
...
suite:case("create", function()
    ...
    test.assertEq(C:New().__module, "ammcore._test.class")
    test.assertEq(C.__fullname, "ammcore._test.class.C")
    test.assertEq(C:New().__fullname, "ammcore._test.class.C")
end)
