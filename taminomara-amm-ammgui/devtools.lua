...
--- @field css ammgui.css.rule.Resolved
--- @field children ammgui.devtools.Element[]
--- @field baseLayout ammgui.component.block.BaseLayout?
--- @field usedLayout ammgui.component.block.UsedLayout?
...
--- @param params ammgui.devtools._ElementParams
--- @return ammgui.dom.AnyNode
local function inlineElement(params)
    return dom.div {
        class = "_amm__devtool__element",
        dom.div {
            class = "_amm__devtool__element-inline-content",
            style = { paddingLeft = u.rem(params.depth * 0.5 + 1.5) },
            dom.text {
                class = "_amm__devtool__element-inline-content-text",
                log.pprint(params.root.inlineContent, true),
            },
...
--- @class ammgui.devtools._ElementParams
--- @field root ammgui.devtools.Element
--- @field depth integer
--- @field expandedIds table<table, true>
--- @field tempExpandedIds table<table, true>
--- @field selectedId table?
--- @field preSelectedId table?
--- @field setSelectedId fun(id: table?)
--- @field setHighlightedId fun(id: table?, c: boolean?, p: boolean?, o: boolean?, m: boolean?)
--- @field setExpandedId fun(id: table, e: boolean)
...
local function _element(ctx, params)
    ...
    if params.root.inlineContent then
        table.insert(div, inlineElement(params))
    end
...
--- @class ammgui.devtools.LayoutCanvasEventListener: ammgui.eventManager.EventListener
ns.LayoutCanvasEventListener = class.create("LayoutCanvasEventListener", eventManager.EventListener)

--- @param setHighlightedId fun(id: table?, c: boolean?, p: boolean?, o: boolean?, m: boolean?)?
--- @param id table?
--- @param kind "content"|"padding"|"outline"|"margin"
--- @param prevKind "content"|"padding"|"outline"|"margin"?
--- @param canvas ammgui.devtools.LayoutCanvas
---
--- !doctype classmethod
--- @generic T: ammgui.devtools.LayoutCanvasEventListener
--- @param self T
--- @return T
function ns.LayoutCanvasEventListener:New(setHighlightedId, id, kind, prevKind, canvas)
    ...
    --- @type fun(id: table?, c: boolean?, p: boolean?, o: boolean?, m: boolean?)?
    self.setHighlightedId = setHighlightedId

    --- @type ammgui.devtools.LayoutCanvas
    self.canvas = canvas
...
--- @class ammgui.devtools.LayoutCanvas: ammgui.component.block.canvas.CanvasBase
...
function LayoutCanvas:draw(params, ctx, size)
    ...
    local outlineSize = structs.Vector2D {
        paddingSize.x + 2 * math.max(self._outlineSize.x, 25) + 20,
        contentSize.y * 5,
    }
    local marginSize = structs.Vector2D {
    ...
    ctx.gpu:drawText(
        (size - marginSize) * 0.5 + structs.Vector2D { 5, 4 }, "Margin", 10, marginOutlineColor, false
    )
    ctx.gpu:drawText(
        (size - outlineSize) * 0.5 + structs.Vector2D { 5, 4 }, "Outline", 10, outlineOutlineColor, false
    )
    ctx.gpu:drawText(
        (size - paddingSize) * 0.5 + structs.Vector2D { 5, 4 }, "Padding", 10, paddingOutlineColor, false
    )
    ...
    self:_drawText(ctx, paddingSize, structs.Vector2D { 0, -1 }, self._paddingTop, self._paddingTopSize,
        paddingOutlineColor, size)
    self:_drawText(ctx, paddingSize, structs.Vector2D { 0, 1 }, self._paddingBottom, self._paddingBottomSize,
        paddingOutlineColor, size)
    self:_drawText(ctx, paddingSize, structs.Vector2D { -1, 0 }, self._paddingLeft, self._paddingLeftSize,
        paddingOutlineColor, size)
    self:_drawText(ctx, paddingSize, structs.Vector2D { 1, 0 }, self._paddingRight, self._paddingRightSize,
        paddingOutlineColor, size)

    self:_drawText(ctx, outlineSize, structs.Vector2D { 0, -1 }, self._outline, self._outlineSize, outlineOutlineColor,
        size)
    self:_drawText(ctx, outlineSize, structs.Vector2D { 0, 1 }, self._outline, self._outlineSize, outlineOutlineColor,
        size)
    self:_drawText(ctx, outlineSize, structs.Vector2D { -1, 0 }, self._outline, self._outlineSize, outlineOutlineColor,
        size)
    self:_drawText(ctx, outlineSize, structs.Vector2D { 1, 0 }, self._outline, self._outlineSize, outlineOutlineColor,
        size)

    self:_drawText(ctx, marginSize, structs.Vector2D { 0, -1 }, self._marginTop, self._marginTopSize, marginOutlineColor,
        size)
    self:_drawText(ctx, marginSize, structs.Vector2D { 0, 1 }, self._marginBottom, self._marginBottomSize,
        marginOutlineColor, size)
    self:_drawText(ctx, marginSize, structs.Vector2D { -1, 0 }, self._marginLeft, self._marginLeftSize,
        marginOutlineColor, size)
    self:_drawText(ctx, marginSize, structs.Vector2D { 1, 0 }, self._marginRight, self._marginRightSize,
        marginOutlineColor, size)
end
...
function LayoutCanvas:_drawText(ctx, size, direction, text, textSize, color, canvasSize)
    local pos = 0.5 * (canvasSize + structs.Vector2D {
...
--- @param cssRule ammgui.css.rule.CompiledRule
--- @param keys string[]
...
--- @param resolved ammgui.css.rule.Resolved
--- @return ammgui.dom.ListNode
local function rules(resolved)
    local result = dom.list {}
...
--- @class ammgui.devtools._ElementDataParams
--- @field root ammgui.devtools.Element?
--- @field setHighlightedId fun(id: table?, c: boolean?, p: boolean?, o: boolean?, m: boolean?)

--- @param ctx ammgui.dom.Context
--- @param params ammgui.devtools._ElementDataParams
--- @return ammgui.dom.AnyNode
...
--- @class ammgui.devtools._SectionParams: ammgui.dom.FunctionalParamsWithChildren
--- @field heading ammgui.dom.AnyNode

--- @param ctx ammgui.dom.Context
--- @param params ammgui.devtools._SectionParams
--- @return ammgui.dom.AnyNode
...
--- @param root ammgui.devtools.Element
--- @param id table?
--- @param tempExpandedIds table<table, true>
...
--- @class ammgui.devtools._PanelParams
--- @field root ammgui.devtools.Element
--- @field selectedId table?
--- @field preSelectedId table?
...
--- @param ctx ammgui.dom.Context
--- @param params ammgui.devtools._PanelParams
--- @return ammgui.dom.AnyNode
